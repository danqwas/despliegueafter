...
public class JwtProvider {
    ...
    public void init() {
        try {
            ...
            InputStream resourceAsStream = getClass().getResourceAsStream("/spring-stream.jks");
            keyStore.load(resourceAsStream, "secret".toCharArray());
        } catch (KeyStoreException | CertificateException | NoSuchAlgorithmException | IOException e){
            throw new ResourceNotFoundException("Exception occurred while loading keystore");
        }
    }
    ...
    private PrivateKey getPrivateKey() {
        try{
            ...
            throw new ResourceNotFoundException("Exception occure while retrieving public key from keystore");
        }
    }
